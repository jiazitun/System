...
import com.jzt.system.bean.MyClass;
import com.jzt.system.config.ParamConfig;
...
public class TestController implements SerialPortEventListener {
    ...
    private static final String PATH="/b.txt";
    // 输入流
            ...
            case SerialPortEvent.DATA_AVAILABLE: // 有数据到达
                ...
                try {
                    ...
                    if(mess!=null)
                    {
                        ...
                        if(myClass.getTagId()!=null){
                            System.out.println("good");
                        }

//                        rfid.setRfidCard(mess);
//                        System.out.println("rfid"+rfid.getRfidCard());
...
//                    iRfidService.deleteAll();
//                    iRfidService.saveOrUpdate(rfid);
                    }
                } catch (Exception e) {
